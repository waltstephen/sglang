...
from sglang.srt.runtime_context import configured_pp_size, configured_attn_cp_size, get_parallel
        ...
        if not self.is_custom_pg:
            for node_idx in range(nnodes):
                ...
                pp_range, tp_range, pp_per_node, tp_per_node = _calculate_rank_ranges(
                    nnodes, configured_pp_size(), server_args.tp_size, node_rank=node_idx
                )
