...
- **Per-instance boundaries** — the tokenizer-manager family, everything under
  ...
  step-12 series; treat them as pinned debt, not as a boundary to imitate. What
...
- **Whole-object passes** (`f(server_args)` handing the instance along) keep the
  ...
  exemption is retracted); their dispositions live in the step-12 doc.
...
- the tokenizer-manager family and `entrypoints/` are **step-12 debt awaiting
